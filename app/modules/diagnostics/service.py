...
def extract_metrics(payload: dict) -> dict:
    ...
    risk = payload.get("risk_score", payload.get("risk", {}))
    ...
    return {
        ...
        "risk_score":          _int(risk.get("score") or risk.get("risk_score")),
...
def store_snapshot(
    ...
    risk = raw_json.get("risk_score", raw_json.get("risk", {}))
    ...
    result = db.execute(
        ...
        """),
        {
            ...
            "risk_score": risk.get("score") or risk.get("risk_score"),
